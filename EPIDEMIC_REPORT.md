...
> **报告日期**: 2026-08-13
> **生成时间**: 2026-08-13T00:59:39.893760+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,901** |
| 📥 本周新增 New (7d) | **154** |
| ✅ 本周关闭 Closed (7d) | **204** |
| 💚 平均健康分 Avg Score | **52.8/100** |
...
**框架**: `mcp` | **健康分数 Health Score**: **71.8/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **62.9/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **61.0/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **39.7/100** | **趋势 Trend**: ↑ improving
