...
> **报告日期**: 2026-04-20
> **生成时间**: 2026-04-20T01:26:41.069777+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,584** |
| 📥 本周新增 New (7d) | **120** |
| ✅ 本周关闭 Closed (7d) | **87** |
| 💚 平均健康分 Avg Score | **43.2/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **67.2/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **64.4/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.7/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **46.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **36.5/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **32.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **32.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **31.5/100** | **趋势 Trend**: ↑ improving
