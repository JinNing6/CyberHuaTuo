...
> **报告日期**: 2026-09-13
> **生成时间**: 2026-09-13T01:51:19.708453+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,163** |
| 📥 本周新增 New (7d) | **255** |
| ✅ 本周关闭 Closed (7d) | **178** |
| 💚 平均健康分 Avg Score | **48.9/100** |
...
- [langchain] ⚠️ 本周新增 81 个 Issues，高于常规水平
...
- [mcp] ⚠️ 关闭率偏低：本周新增 16，仅关闭 0
- [mcp] 🔴 存在 5 个高影响 Bug Issues
- [mcp] 🐛 Bug 类 Issue 占比达 41%
- [pydantic-ai] ⚠️ 本周新增 58 个 Issues，高于常规水平
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.6/100** | **趋势 Trend**: → stable
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **67.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **62.0/100** | **趋势 Trend**: ↓ declining
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **55.1/100** | **趋势 Trend**: ↓ declining
...
- [[BUG] LLMGuardrail reports an LLM/provider error as a failed validation, and the](https://github.com/crewAIInc/crewAI/issues/7150) (👍 0)

---

### 🟠 langchain-ai/langchain
**框架**: `langchain` | **健康分数 Health Score**: **43.9/100** | **趋势 Trend**: → stable
...
- [Support dynamic tool addition/removal after agent creation and in middleware](https://github.com/langchain-ai/langchain/issues/33808) (👍 16 / 💬 18)
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **40.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **29.7/100** | **趋势 Trend**: → stable
