...
> **报告日期**: 2026-04-10
> **生成时间**: 2026-04-10T01:20:12.106559+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,556** |
| 📥 本周新增 New (7d) | **145** |
| ✅ 本周关闭 Closed (7d) | **180** |
| 💚 平均健康分 Avg Score | **50.6/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **81.1/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **63.0/100** | **趋势 Trend**: ↑ improving
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **59.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **56.1/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **51.7/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **48.9/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.2/100** | **趋势 Trend**: ↑ improving
