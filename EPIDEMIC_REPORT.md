...
> **报告日期**: 2026-06-06
> **生成时间**: 2026-06-06T02:01:41.914019+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,708** |
| 📥 本周新增 New (7d) | **111** |
| ✅ 本周关闭 Closed (7d) | **137** |
| 💚 平均健康分 Avg Score | **49.8/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **78.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **60.5/100** | **趋势 Trend**: ↑ improving
...
**🔥 热门 Issues / Hot Issues**:
- [[horizontal scaling] How to actually build session persistence in streamable htt](https://github.com/modelcontextprotocol/python-sdk/issues/880) (👍 24 / 💬 19)
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **55.5/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **38.0/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **27.2/100** | **趋势 Trend**: → stable
