...
> **报告日期**: 2026-05-27
> **生成时间**: 2026-05-27T02:11:26.685916+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,696** |
| 📥 本周新增 New (7d) | **121** |
| ✅ 本周关闭 Closed (7d) | **92** |
| 💚 平均健康分 Avg Score | **44.1/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **73.6/100** | **趋势 Trend**: ↓ declining
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **45.1/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **38.1/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **34.7/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.4/100** | **趋势 Trend**: → stable
