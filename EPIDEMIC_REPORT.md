...
> **报告日期**: 2026-08-25
> **生成时间**: 2026-08-25T00:35:21.261470+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 21，仅关闭 1
- [langgraph] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] 🐛 Bug 类 Issue 占比达 40%
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **65.9/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **37.2/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **28.6/100** | **趋势 Trend**: → stable
