...
> **报告日期**: 2026-03-29
> **生成时间**: 2026-03-29T01:19:16.170178+00:00
...
- [langchain] ⚠️ 本周新增 52 个 Issues，高于常规水平
- [langchain] 🔴 存在 5 个高影响 Bug Issues
- [langchain] 🐛 Bug 类 Issue 占比达 46%
- [crewai] ⚠️ 关闭率偏低：本周新增 27，仅关闭 6
- [crewai] 🔴 存在 5 个高影响 Bug Issues
- [autogen] ⚠️ 关闭率偏低：本周新增 11，仅关闭 1
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **72.0/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **68.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **61.7/100** | **趋势 Trend**: ↑ improving
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.4/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **45.6/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **44.7/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **40.2/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **34.5/100** | **趋势 Trend**: → stable
...
- [[SECURITY] Critical Vulnerability Disclosure](https://github.com/crewAIInc/crewAI/issues/4610) (👍 0)

---

### 🔴 langchain-ai/langgraph
**框架**: `langgraph` | **健康分数 Health Score**: **25.0/100** | **趋势 Trend**: → stable
