...
> **报告日期**: 2026-08-06
> **生成时间**: 2026-08-06T01:23:04.786840+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,949** |
| 📥 本周新增 New (7d) | **175** |
| ✅ 本周关闭 Closed (7d) | **147** |
| 💚 平均健康分 Avg Score | **49.5/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **63.2/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **57.2/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.6/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.3/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **45.2/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **30.0/100** | **趋势 Trend**: → stable
