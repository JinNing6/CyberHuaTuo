...
> **报告日期**: 2026-06-20
> **生成时间**: 2026-06-20T02:10:48.174895+00:00
...
- [mcp] ⚠️ 关闭率偏低：本周新增 17，仅关闭 2
- [mcp] 🔴 存在 5 个高影响 Bug Issues
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 22，仅关闭 5
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.7/100** | **趋势 Trend**: ↓ declining
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **57.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **55.0/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **48.2/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.2/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **36.7/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.0/100** | **趋势 Trend**: ↓ declining
