...
> **报告日期**: 2026-07-04
> **生成时间**: 2026-07-04T01:49:22.913383+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,738** |
| 📥 本周新增 New (7d) | **155** |
| ✅ 本周关闭 Closed (7d) | **190** |
| 💚 平均健康分 Avg Score | **52.6/100** |
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **88.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **82.4/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **48.7/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **46.5/100** | **趋势 Trend**: → stable
