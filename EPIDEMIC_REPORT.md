...
> **报告日期**: 2026-06-13
> **生成时间**: 2026-06-13T02:09:02.987933+00:00
...
- [langchain] 🐛 Bug 类 Issue 占比达 58%
- [crewai] ⚠️ 关闭率偏低：本周新增 16，仅关闭 1
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 14，仅关闭 2
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.1/100** | **趋势 Trend**: → stable
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **66.0/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **62.8/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **62.0/100** | **趋势 Trend**: → stable
...
- [[Feature Request] Native Support for MCP Code Execution (Programmatic Tool Calli](https://github.com/langchain-ai/langchain/issues/34130) (👍 30 / 💬 10)
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **52.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **49.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **46.2/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **36.6/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.7/100** | **趋势 Trend**: → stable
