...
> **报告日期**: 2026-06-09
> **生成时间**: 2026-06-09T01:58:03.746219+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,729** |
| 📥 本周新增 New (7d) | **107** |
| ✅ 本周关闭 Closed (7d) | **130** |
| 💚 平均健康分 Avg Score | **49.4/100** |
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **88.0/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **50.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **42.8/100** | **趋势 Trend**: → stable
...
**异常告警 Anomalies**:
- ⚠️ 关闭率偏低：本周新增 19，仅关闭 5
- 🔴 存在 5 个高影响 Bug Issues

**🔥 热门 Issues / Hot Issues**:
- [[horizontal scaling] How to actually build session persistence in streamable htt](https://github.com/modelcontextprotocol/python-sdk/issues/880) (👍 24 / 💬 20)
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **40.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.9/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.8/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **24.5/100** | **趋势 Trend**: ↑ improving
