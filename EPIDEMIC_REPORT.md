...
> **报告日期**: 2026-06-26
> **生成时间**: 2026-06-26T02:08:23.021504+00:00
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **70.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **55.2/100** | **趋势 Trend**: ↑ improving
...
- [MCP SSE Server: Received request before initialization was complete](https://github.com/modelcontextprotocol/python-sdk/issues/423) (👍 27 / 💬 25)
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **42.9/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **27.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **17.9/100** | **趋势 Trend**: ↑ improving
