...
> **报告日期**: 2026-09-07
> **生成时间**: 2026-09-07T01:40:49.166894+00:00
...
- [pydantic-ai] ⚠️ 本周新增 61 个 Issues，高于常规水平
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 22，仅关闭 0
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **66.4/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.5/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **57.0/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langchain` | **健康分数 Health Score**: **47.6/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **40.8/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **31.5/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **30.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **30.6/100** | **趋势 Trend**: → stable
