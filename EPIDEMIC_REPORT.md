...
> **报告日期**: 2026-09-11
> **生成时间**: 2026-09-11T01:53:01.370350+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,124** |
| 📥 本周新增 New (7d) | **256** |
| ✅ 本周关闭 Closed (7d) | **216** |
| 💚 平均健康分 Avg Score | **47.7/100** |
...
- [langchain] ⚠️ 本周新增 87 个 Issues，高于常规水平
...
- [pydantic-ai] ⚠️ 本周新增 53 个 Issues，高于常规水平
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 26，仅关闭 1
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **57.7/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **56.5/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **44.8/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **43.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.7/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **30.3/100** | **趋势 Trend**: → stable
