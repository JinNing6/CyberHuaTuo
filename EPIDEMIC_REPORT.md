...
> **报告日期**: 2026-06-10
> **生成时间**: 2026-06-10T02:09:57.112533+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,736** |
| 📥 本周新增 New (7d) | **116** |
| ✅ 本周关闭 Closed (7d) | **133** |
| 💚 平均健康分 Avg Score | **49.7/100** |
...
- [langchain] 🐛 Bug 类 Issue 占比达 53%
- [crewai] ⚠️ 关闭率偏低：本周新增 12，仅关闭 2
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **85.0/100** | **趋势 Trend**: → stable
...
- [[Feature Request] Native Support for MCP Code Execution (Programmatic Tool Calli](https://github.com/langchain-ai/langchain/issues/34130) (👍 30 / 💬 9)
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **54.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **44.3/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **42.4/100** | **趋势 Trend**: → stable
...
**异常告警 Anomalies**:
- ⚠️ 关闭率偏低：本周新增 18，仅关闭 4
- 🔴 存在 5 个高影响 Bug Issues

**🔥 热门 Issues / Hot Issues**:
- [[horizontal scaling] How to actually build session persistence in streamable htt](https://github.com/modelcontextprotocol/python-sdk/issues/880) (👍 24 / 💬 21)
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **36.5/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.6/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **32.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **27.1/100** | **趋势 Trend**: ↑ improving
...
**🔥 热门 Issues / Hot Issues**:
- [langgraph-checkpoint-postgres (psycopg.OperationalError: sending query and param](https://github.com/langchain-ai/langgraph/issues/3716) (👍 12 / 💬 49)
