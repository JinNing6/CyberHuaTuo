...
> **报告日期**: 2026-08-28
> **生成时间**: 2026-08-28T07:28:21.551570+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 19，仅关闭 1
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **76.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **61.5/100** | **趋势 Trend**: → stable
...
### 🟠 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **56.3/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **39.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **36.7/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **35.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **25.9/100** | **趋势 Trend**: → stable
