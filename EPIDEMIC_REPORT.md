...
> **报告日期**: 2026-08-12
> **生成时间**: 2026-08-12T00:58:11.138800+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 19，仅关闭 4
...
**框架**: `mcp` | **健康分数 Health Score**: **71.6/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **64.2/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **62.4/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **61.3/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **61.2/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **40.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **32.3/100** | **趋势 Trend**: → stable
