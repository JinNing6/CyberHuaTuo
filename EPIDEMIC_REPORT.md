...
> **报告日期**: 2026-08-04
> **生成时间**: 2026-08-04T01:21:09.537828+00:00
...
- [pydantic-ai] ⚠️ 本周新增 125 个 Issues，高于常规水平
...
**框架**: `mcp` | **健康分数 Health Score**: **66.9/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.3/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langchain` | **健康分数 Health Score**: **50.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **40.7/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **27.6/100** | **趋势 Trend**: ↑ improving
