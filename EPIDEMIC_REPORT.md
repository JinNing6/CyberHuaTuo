...
> **报告日期**: 2026-07-07
> **生成时间**: 2026-07-07T02:01:32.898325+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,755** |
| 📥 本周新增 New (7d) | **128** |
| ✅ 本周关闭 Closed (7d) | **152** |
| 💚 平均健康分 Avg Score | **50.4/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **82.7/100** | **趋势 Trend**: → stable
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.7/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **56.1/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **51.5/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **47.2/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **29.8/100** | **趋势 Trend**: ↑ improving
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 9 / 💬 26)
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **27.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **25.0/100** | **趋势 Trend**: ↓ declining
...
- [Consider migrating from httpx to httpx2](https://github.com/openai/openai-python/issues/3375) (👍 24 / 💬 1)
