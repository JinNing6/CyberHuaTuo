...
> **报告日期**: 2026-06-12
> **生成时间**: 2026-06-12T02:27:45.813013+00:00
...
- [langchain] 🐛 Bug 类 Issue 占比达 56%
- [crewai] ⚠️ 关闭率偏低：本周新增 14，仅关闭 1
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **57.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **46.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **42.1/100** | **趋势 Trend**: ↓ declining
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **31.4/100** | **趋势 Trend**: → stable
