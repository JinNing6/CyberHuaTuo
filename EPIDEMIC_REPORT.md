...
> **报告日期**: 2026-04-12
> **生成时间**: 2026-04-12T01:23:56.169238+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 13，仅关闭 1
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **81.2/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **63.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **49.7/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **28.1/100** | **趋势 Trend**: ↑ improving
