...
> **报告日期**: 2026-05-24
> **生成时间**: 2026-05-24T02:03:52.565529+00:00
...
- [openai-sdk] ⚠️ 关闭率偏低：本周新增 11，仅关闭 0
...
**框架**: `mcp` | **健康分数 Health Score**: **69.6/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **64.5/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langchain` | **健康分数 Health Score**: **48.3/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **43.0/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **41.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.0/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **32.7/100** | **趋势 Trend**: → stable
