...
> **报告日期**: 2026-09-01
> **生成时间**: 2026-09-01T02:26:31.270811+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,013** |
| 📥 本周新增 New (7d) | **186** |
| ✅ 本周关闭 Closed (7d) | **155** |
| 💚 平均健康分 Avg Score | **50.3/100** |
...
- [pydantic-ai] ⚠️ 本周新增 72 个 Issues，高于常规水平
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **75.5/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.4/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **48.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **46.5/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **44.9/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **38.0/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **27.4/100** | **趋势 Trend**: → stable
