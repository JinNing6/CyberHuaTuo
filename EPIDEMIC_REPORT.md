...
> **报告日期**: 2026-03-21
> **生成时间**: 2026-03-21T01:03:49.216699+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,444** |
| 📥 本周新增 New (7d) | **147** |
| ✅ 本周关闭 Closed (7d) | **129** |
| 💚 平均健康分 Avg Score | **52.0/100** |
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **84.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.0/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **50.3/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **46.9/100** | **趋势 Trend**: → stable
