...
> **报告日期**: 2026-08-17
> **生成时间**: 2026-08-17T00:34:36.598654+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,913** |
| 📥 本周新增 New (7d) | **150** |
| ✅ 本周关闭 Closed (7d) | **140** |
| 💚 平均健康分 Avg Score | **46.2/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 17，仅关闭 0
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **64.5/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **64.4/100** | **趋势 Trend**: → stable
...
### 🟠 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **59.7/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **53.6/100** | **趋势 Trend**: ↓ declining
...
**框架**: `mcp` | **健康分数 Health Score**: **49.4/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **38.7/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.9/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 9 / 💬 36)
