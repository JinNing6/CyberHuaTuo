...
> **报告日期**: 2026-04-25
> **生成时间**: 2026-04-25T01:19:58.186202+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 15，仅关闭 3
...
**框架**: `llamaindex` | **健康分数 Health Score**: **52.4/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **45.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **41.9/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **38.5/100** | **趋势 Trend**: → stable
...
- [Bug bounty](https://github.com/langchain-ai/langchain/issues/36952) (👍 9)

---

### 🔴 langchain-ai/langgraph
**框架**: `langgraph` | **健康分数 Health Score**: **23.9/100** | **趋势 Trend**: → stable
