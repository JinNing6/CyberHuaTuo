...
> **报告日期**: 2026-04-14
> **生成时间**: 2026-04-14T01:23:58.565007+00:00
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **81.4/100** | **趋势 Trend**: ↑ improving
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **76.2/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **66.2/100** | **趋势 Trend**: → stable
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.2/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **52.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **38.8/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **33.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **33.4/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **25.0/100** | **趋势 Trend**: → stable
