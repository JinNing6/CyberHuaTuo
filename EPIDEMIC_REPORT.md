...
> **报告日期**: 2026-08-11
> **生成时间**: 2026-08-11T00:51:19.009787+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,902** |
| 📥 本周新增 New (7d) | **433** |
| ✅ 本周关闭 Closed (7d) | **447** |
| 💚 平均健康分 Avg Score | **55.3/100** |
...
- [langchain] ⚠️ 本周新增 215 个 Issues，高于常规水平
- [langchain] 🔴 存在 5 个高影响 Bug Issues
- [langchain] 🐛 Bug 类 Issue 占比达 62%
- [crewai] ⚠️ 本周新增 72 个 Issues，高于常规水平
...
**框架**: `mcp` | **健康分数 Health Score**: **66.9/100** | **趋势 Trend**: ↑ improving
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **66.1/100** | **趋势 Trend**: → stable
...
### 🟡 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **63.3/100** | **趋势 Trend**: ↑ improving
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **62.0/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **61.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **52.2/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **33.9/100** | **趋势 Trend**: → stable
