...
> **报告日期**: 2026-07-05
> **生成时间**: 2026-07-05T01:55:04.732521+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,743** |
| 📥 本周新增 New (7d) | **145** |
| ✅ 本周关闭 Closed (7d) | **187** |
| 💚 平均健康分 Avg Score | **52.9/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **82.3/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **49.3/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **42.5/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.4/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.5/100** | **趋势 Trend**: → stable
