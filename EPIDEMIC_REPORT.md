...
> **报告日期**: 2026-08-20
> **生成时间**: 2026-08-20T00:34:23.892796+00:00
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **57.8/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **51.7/100** | **趋势 Trend**: → stable
...
- [core: leak when using object member in a `RunnableSequence`](https://github.com/langchain-ai/langchain/issues/30667) (👍 2)

---

### 🟠 run-llama/llama_index
**框架**: `llamaindex` | **健康分数 Health Score**: **43.7/100** | **趋势 Trend**: ↓ declining
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **39.0/100** | **趋势 Trend**: ↑ improving
