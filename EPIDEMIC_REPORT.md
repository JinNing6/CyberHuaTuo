...
> **报告日期**: 2026-04-13
> **生成时间**: 2026-04-13T01:26:02.030371+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,553** |
| 📥 本周新增 New (7d) | **122** |
| ✅ 本周关闭 Closed (7d) | **168** |
| 💚 平均健康分 Avg Score | **50.0/100** |
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **82.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **81.2/100** | **趋势 Trend**: ↑ improving
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **65.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **47.8/100** | **趋势 Trend**: ↑ improving
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **45.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **28.2/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **22.1/100** | **趋势 Trend**: → stable
