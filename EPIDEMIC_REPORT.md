...
> **报告日期**: 2026-04-27
> **生成时间**: 2026-04-27T01:30:03.408803+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,631** |
| 📥 本周新增 New (7d) | **118** |
| ✅ 本周关闭 Closed (7d) | **84** |
| 💚 平均健康分 Avg Score | **44.7/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 13，仅关闭 3
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **65.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.7/100** | **趋势 Trend**: → stable
...
- [Google support both function tools and built-in tools](https://github.com/pydantic/pydantic-ai/issues/4788) (👍 4)

---

### 🟠 run-llama/llama_index
**框架**: `llamaindex` | **健康分数 Health Score**: **53.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **47.6/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.5/100** | **趋势 Trend**: ↑ improving
...
- [[BUG] TypeError: Object of type File is not JSON serializable when using input_f](https://github.com/crewAIInc/crewAI/issues/4498) (👍 0)

---

### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.1/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **37.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **24.5/100** | **趋势 Trend**: → stable
