...
> **报告日期**: 2026-08-03
> **生成时间**: 2026-08-03T01:45:15.299790+00:00
...
**框架**: `langchain` | **健康分数 Health Score**: **49.0/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **45.2/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **42.6/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **33.0/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **24.1/100** | **趋势 Trend**: ↑ improving
