...
> **报告日期**: 2026-07-24
> **生成时间**: 2026-07-24T01:29:15.979198+00:00
...
- [mcp] ⚠️ 关闭率偏低：本周新增 13，仅关闭 0
- [mcp] 🔴 存在 5 个高影响 Bug Issues
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 18，仅关闭 2
...
### 🟢 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **87.0/100** | **趋势 Trend**: ↑ improving
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **67.3/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **61.7/100** | **趋势 Trend**: ↑ improving
...
- [[BUG]  `human_input=True`: the feedback prompt references a "Final Result above"](https://github.com/crewAIInc/crewAI/issues/6072) (👍 0)
- [[BUG] Bare raise in get_uploader() causes RuntimeError instead of PermanentUploa](https://github.com/crewAIInc/crewAI/issues/6568) (👍 0)

---

### 🟠 run-llama/llama_index
**框架**: `llamaindex` | **健康分数 Health Score**: **44.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **36.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **34.8/100** | **趋势 Trend**: ↓ declining
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **31.5/100** | **趋势 Trend**: → stable
...
- [Consider migrating from httpx to httpx2](https://github.com/openai/openai-python/issues/3375) (👍 31 / 💬 4)
