...
> **报告日期**: 2026-08-30
> **生成时间**: 2026-08-30T02:10:45.188984+00:00
...
- [pydantic-ai] ⚠️ 本周新增 65 个 Issues，高于常规水平
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **62.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **46.0/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **40.9/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **37.8/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **35.0/100** | **趋势 Trend**: ↓ declining
