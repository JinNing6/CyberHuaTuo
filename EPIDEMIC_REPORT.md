...
> **报告日期**: 2026-03-26
> **生成时间**: 2026-03-26T01:16:23.578744+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,504** |
| 📥 本周新增 New (7d) | **160** |
| ✅ 本周关闭 Closed (7d) | **95** |
| 💚 平均健康分 Avg Score | **44.2/100** |
...
- [crewai] ⚠️ 关闭率偏低：本周新增 21，仅关闭 6
- [crewai] 🔴 存在 5 个高影响 Bug Issues
- [autogen] ⚠️ 关闭率偏低：本周新增 12，仅关闭 0
...
**框架**: `mcp` | **健康分数 Health Score**: **56.5/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **51.1/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **40.6/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **36.6/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **35.6/100** | **趋势 Trend**: → stable
...
- [[BUG] Pydantic Validation error while saving in Memory](https://github.com/crewAIInc/crewAI/issues/4509) (👍 0)

---

### 🔴 langchain-ai/langgraph
**框架**: `langgraph` | **健康分数 Health Score**: **26.2/100** | **趋势 Trend**: → stable
