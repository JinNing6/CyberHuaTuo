...
> **报告日期**: 2026-08-07
> **生成时间**: 2026-08-07T02:02:35.921643+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,970** |
| 📥 本周新增 New (7d) | **191** |
| ✅ 本周关闭 Closed (7d) | **142** |
| 💚 平均健康分 Avg Score | **51.3/100** |
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **65.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.6/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **30.3/100** | **趋势 Trend**: → stable
