...
> **报告日期**: 2026-04-11
> **生成时间**: 2026-04-11T01:14:39.736460+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 15，仅关闭 1
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **81.4/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **62.5/100** | **趋势 Trend**: ↑ improving
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.8/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **55.6/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **49.7/100** | **趋势 Trend**: → stable
...
- [[BUG] fix: CrewAI 1.12.x LLM routing - litellm does not receive api_base/api_key](https://github.com/crewAIInc/crewAI/issues/5139) (👍 0)

---

### 🟠 langchain-ai/langchain
**框架**: `langchain` | **健康分数 Health Score**: **48.6/100** | **趋势 Trend**: → stable
...
- [[Feature Request] Native Support for MCP Code Execution (Programmatic Tool Calli](https://github.com/langchain-ai/langchain/issues/34130) (👍 28 / 💬 5)
...
- [`langchain_core.exceptions.OutputParserException`](https://github.com/langchain-ai/langchain/issues/36603) (👍 11)

---

### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.2/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.0/100** | **趋势 Trend**: → stable
