...
> **报告日期**: 2026-09-02
> **生成时间**: 2026-09-02T01:47:51.009456+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,023** |
| 📥 本周新增 New (7d) | **195** |
| ✅ 本周关闭 Closed (7d) | **165** |
| 💚 平均健康分 Avg Score | **50.9/100** |
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **75.6/100** | **趋势 Trend**: → stable
...
- [[BUG] Gemini native provider never appends trailing user turn -> 400 'Requests e](https://github.com/crewAIInc/crewAI/issues/6984) (👍 0)
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.1/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **61.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **57.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **47.4/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **44.5/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.9/100** | **趋势 Trend**: ↑ improving
