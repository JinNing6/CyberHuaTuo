...
> **报告日期**: 2026-04-26
> **生成时间**: 2026-04-26T01:29:28.123132+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 16，仅关闭 3
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **65.7/100** | **趋势 Trend**: → stable
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **57.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **52.3/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **44.2/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **43.3/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **37.1/100** | **趋势 Trend**: → stable
