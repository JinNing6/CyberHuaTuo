...
> **报告日期**: 2026-05-18
> **生成时间**: 2026-05-18T02:07:17.144209+00:00
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **63.4/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **62.5/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **42.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **41.2/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **35.9/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **29.4/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **25.8/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.6/100** | **趋势 Trend**: → stable
