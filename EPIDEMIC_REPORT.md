...
> **报告日期**: 2026-05-13
> **生成时间**: 2026-05-13T01:59:52.633869+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,598** |
| 📥 本周新增 New (7d) | **102** |
| ✅ 本周关闭 Closed (7d) | **102** |
| 💚 平均健康分 Avg Score | **49.6/100** |
...
### 🟡 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **67.8/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **57.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **40.1/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **39.9/100** | **趋势 Trend**: → stable
