...
> **报告日期**: 2026-07-02
> **生成时间**: 2026-07-02T02:05:52.187530+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 18，仅关闭 4
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **77.9/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **74.5/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **68.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **43.1/100** | **趋势 Trend**: → stable
