...
> **报告日期**: 2026-04-17
> **生成时间**: 2026-04-17T01:24:01.302463+00:00
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **74.9/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **63.7/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **36.9/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **35.9/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **33.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **32.1/100** | **趋势 Trend**: → stable
