...
> **报告日期**: 2026-07-26
> **生成时间**: 2026-07-26T01:43:11.755309+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,849** |
| 📥 本周新增 New (7d) | **131** |
| ✅ 本周关闭 Closed (7d) | **123** |
| 💚 平均健康分 Avg Score | **52.4/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 20，仅关闭 4
...
**框架**: `mcp` | **健康分数 Health Score**: **69.0/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **58.9/100** | **趋势 Trend**: → stable
...
**🚨 高危 Issues / Critical Issues**:
- [[BUG] Reasoning plan always detects "NOT READY" even though the model indicates ](https://github.com/crewAIInc/crewAI/issues/6204) (👍 0)
...
**框架**: `llamaindex` | **健康分数 Health Score**: **45.7/100** | **趋势 Trend**: ↑ improving
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **36.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **32.0/100** | **趋势 Trend**: → stable
