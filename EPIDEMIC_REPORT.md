...
> **报告日期**: 2026-06-07
> **生成时间**: 2026-06-07T02:28:33.770556+00:00
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **80.9/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **51.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **46.9/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **44.5/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **39.1/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **39.0/100** | **趋势 Trend**: → stable
