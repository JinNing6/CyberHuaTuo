...
> **报告日期**: 2026-08-09
> **生成时间**: 2026-08-09T00:49:26.447779+00:00
...
- [pydantic-ai] ⚠️ 本周新增 122 个 Issues，高于常规水平
...
**框架**: `langchain` | **健康分数 Health Score**: **64.1/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **61.3/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **60.9/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **44.7/100** | **趋势 Trend**: → stable
