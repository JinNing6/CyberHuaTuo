...
> **报告日期**: 2026-04-22
> **生成时间**: 2026-04-22T01:22:20.733775+00:00
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **86.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **71.4/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **55.4/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **50.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **46.6/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **39.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **32.8/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **29.7/100** | **趋势 Trend**: → stable
