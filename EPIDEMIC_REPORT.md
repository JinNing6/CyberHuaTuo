...
> **报告日期**: 2026-08-21
> **生成时间**: 2026-08-21T00:36:36.096647+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,960** |
| 📥 本周新增 New (7d) | **197** |
| ✅ 本周关闭 Closed (7d) | **128** |
| 💚 平均健康分 Avg Score | **43.9/100** |
...
- [langchain] ⚠️ 本周新增 68 个 Issues，高于常规水平
...
**框架**: `langchain` | **健康分数 Health Score**: **49.8/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **40.4/100** | **趋势 Trend**: ↓ declining
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.5/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **33.2/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **25.8/100** | **趋势 Trend**: → stable
