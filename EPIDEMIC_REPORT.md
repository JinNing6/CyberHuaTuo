...
> **报告日期**: 2026-06-16
> **生成时间**: 2026-06-16T02:39:37.639771+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 21，仅关闭 2
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **70.7/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **66.7/100** | **趋势 Trend**: → stable
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **59.5/100** | **趋势 Trend**: ↓ declining
...
**框架**: `mcp` | **健康分数 Health Score**: **49.0/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **42.1/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **40.2/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **32.7/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **28.7/100** | **趋势 Trend**: ↓ declining
