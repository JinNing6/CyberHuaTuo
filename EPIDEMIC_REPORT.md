...
> **报告日期**: 2026-06-30
> **生成时间**: 2026-06-30T02:09:04.778059+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,789** |
| 📥 本周新增 New (7d) | **135** |
| ✅ 本周关闭 Closed (7d) | **110** |
| 💚 平均健康分 Avg Score | **45.9/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.8/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **68.7/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **40.5/100** | **趋势 Trend**: ↑ improving
...
- [[BUG] OpenAI API call fails with "response_format type is unavailable now" when ](https://github.com/crewAIInc/crewAI/issues/5990) (👍 0)

---

### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **37.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.3/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 8 / 💬 23)
