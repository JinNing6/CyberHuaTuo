...
> **报告日期**: 2026-09-09
> **生成时间**: 2026-09-09T01:57:37.665475+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,132** |
| 📥 本周新增 New (7d) | **269** |
| ✅ 本周关闭 Closed (7d) | **174** |
| 💚 平均健康分 Avg Score | **47.9/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **67.5/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **58.7/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **57.0/100** | **趋势 Trend**: → stable
...
- [[BUG] Agent.kickoff_async guardrail retry calls sync invoke inside event loop](https://github.com/crewAIInc/crewAI/issues/7252) (👍 0)
...
**框架**: `langchain` | **健康分数 Health Score**: **45.9/100** | **趋势 Trend**: → stable
...
- [Support dynamic tool addition/removal after agent creation and in middleware](https://github.com/langchain-ai/langchain/issues/33808) (👍 15 / 💬 18)
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.3/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **31.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **29.9/100** | **趋势 Trend**: → stable
