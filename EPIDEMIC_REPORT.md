...
> **报告日期**: 2026-08-16
> **生成时间**: 2026-08-16T00:36:03.968617+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 18，仅关闭 0
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **64.0/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **61.5/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **54.7/100** | **趋势 Trend**: ↓ declining
