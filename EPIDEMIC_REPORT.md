...
> **报告日期**: 2026-05-07
> **生成时间**: 2026-05-07T01:51:28.586412+00:00
...
- [Parallel MCP servers: `RuntimeError: Attempted to exit cancel scope in a differe](https://github.com/pydantic/pydantic-ai/issues/2818) (👍 8)
- [Google support both function tools and built-in tools](https://github.com/pydantic/pydantic-ai/issues/4788) (👍 6)

---

### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **55.9/100** | **趋势 Trend**: ↑ improving
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.4/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **33.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **22.2/100** | **趋势 Trend**: → stable
