...
> **报告日期**: 2026-05-26
> **生成时间**: 2026-05-26T02:03:08.276806+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,691** |
| 📥 本周新增 New (7d) | **124** |
| ✅ 本周关闭 Closed (7d) | **100** |
| 💚 平均健康分 Avg Score | **43.5/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **67.7/100** | **趋势 Trend**: ↓ declining
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **63.8/100** | **趋势 Trend**: ↓ declining
...
**框架**: `mcp` | **健康分数 Health Score**: **47.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **42.0/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **38.1/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.6/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **37.2/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **32.2/100** | **趋势 Trend**: → stable
