...
> **报告日期**: 2026-04-23
> **生成时间**: 2026-04-23T01:27:13.732206+00:00
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **84.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **66.8/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **49.4/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **48.3/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **41.9/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **39.0/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **38.4/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.6/100** | **趋势 Trend**: → stable
