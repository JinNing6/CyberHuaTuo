...
> **报告日期**: 2026-05-04
> **生成时间**: 2026-05-04T01:47:29.819980+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,593** |
| 📥 本周新增 New (7d) | **69** |
| ✅ 本周关闭 Closed (7d) | **100** |
| 💚 平均健康分 Avg Score | **48.3/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 12，仅关闭 2
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **80.0/100** | **趋势 Trend**: ↑ improving
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **64.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **57.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **54.8/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **28.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **27.9/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **23.5/100** | **趋势 Trend**: → stable
