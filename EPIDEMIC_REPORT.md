...
> **报告日期**: 2026-04-18
> **生成时间**: 2026-04-18T01:17:30.934957+00:00
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **73.7/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **72.2/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **60.2/100** | **趋势 Trend**: → stable
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **60.0/100** | **趋势 Trend**: ↑ improving
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **44.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **38.8/100** | **趋势 Trend**: ↑ improving
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 7 / 💬 10)
...
**框架**: `llamaindex` | **健康分数 Health Score**: **37.5/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **35.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **35.5/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **23.9/100** | **趋势 Trend**: ↓ declining
