...
> **报告日期**: 2026-07-15
> **生成时间**: 2026-07-15T01:15:45.247647+00:00
...
- [llamaindex] ⚠️ 关闭率偏低：本周新增 17，仅关闭 5
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **69.7/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **44.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **33.7/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **26.3/100** | **趋势 Trend**: ↑ improving
