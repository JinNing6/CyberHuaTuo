...
> **报告日期**: 2026-03-20
> **生成时间**: 2026-03-20T01:08:12.354065+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,437** |
| 📥 本周新增 New (7d) | **151** |
| ✅ 本周关闭 Closed (7d) | **122** |
| 💚 平均健康分 Avg Score | **50.7/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **71.9/100** | **趋势 Trend**: → stable
...
- [Support for Crawler in Haystack 2.x](https://github.com/deepset-ai/haystack/issues/6609) (👍 3 / 💬 8)

---

### 🟡 modelcontextprotocol/python-sdk
**框架**: `mcp` | **健康分数 Health Score**: **60.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **58.8/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **54.8/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **50.0/100** | **趋势 Trend**: → stable
...
- [[BUG] Hierarchical process delegation fails - manager agents cannot delegate to ](https://github.com/crewAIInc/crewAI/issues/4783) (👍 0)

---

### 🟠 openai/openai-python
**框架**: `openai-sdk` | **健康分数 Health Score**: **47.0/100** | **趋势 Trend**: ↑ improving
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **44.6/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 7 / 💬 6)
