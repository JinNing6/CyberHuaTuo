...
> **报告日期**: 2026-09-12
> **生成时间**: 2026-09-12T01:58:08.016218+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,147** |
| 📥 本周新增 New (7d) | **260** |
| ✅ 本周关闭 Closed (7d) | **218** |
| 💚 平均健康分 Avg Score | **47.6/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **70.5/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **57.7/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **56.6/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.8/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **31.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **29.7/100** | **趋势 Trend**: ↓ declining
