...
> **报告日期**: 2026-07-31
> **生成时间**: 2026-07-31T01:45:14.578788+00:00
...
- [crewai] ⚠️ 关闭率偏低：本周新增 27，仅关闭 7
- [crewai] 🔴 存在 5 个高影响 Bug Issues
- [llamaindex] ⚠️ 关闭率偏低：本周新增 12，仅关闭 3
...
- [pydantic-ai] ⚠️ 本周新增 105 个 Issues，高于常规水平
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **58.6/100** | **趋势 Trend**: ↓ declining
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.7/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langchain` | **健康分数 Health Score**: **39.1/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **29.5/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **20.0/100** | **趋势 Trend**: ↓ declining
