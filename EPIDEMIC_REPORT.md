...
> **报告日期**: 2026-03-22
> **生成时间**: 2026-03-22T01:11:23.640145+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,462** |
| 📥 本周新增 New (7d) | **142** |
| ✅ 本周关闭 Closed (7d) | **127** |
| 💚 平均健康分 Avg Score | **50.5/100** |
...
### 🟢 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **82.9/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **60.9/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **55.8/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **54.2/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **50.8/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.7/100** | **趋势 Trend**: → stable
