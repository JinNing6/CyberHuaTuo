...
> **报告日期**: 2026-08-24
> **生成时间**: 2026-08-24T00:35:52.331497+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,987** |
| 📥 本周新增 New (7d) | **188** |
| ✅ 本周关闭 Closed (7d) | **126** |
| 💚 平均健康分 Avg Score | **44.5/100** |
...
- [llamaindex] ⚠️ 关闭率偏低：本周新增 13，仅关闭 3
...
- [pydantic-ai] ⚠️ 本周新增 59 个 Issues，高于常规水平
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 19，仅关闭 2
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **63.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **49.1/100** | **趋势 Trend**: ↓ declining
...
**🔥 热门 Issues / Hot Issues**:
- [The batch method from ChatModels and all the Runnables does not really support t](https://github.com/langchain-ai/langchain/issues/28508) (👍 37 / 💬 16)
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **49.0/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **37.6/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.3/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **28.7/100** | **趋势 Trend**: → stable
