...
> **报告日期**: 2026-06-22
> **生成时间**: 2026-06-22T02:38:30.937729+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,762** |
| 📥 本周新增 New (7d) | **122** |
| ✅ 本周关闭 Closed (7d) | **49** |
| 💚 平均健康分 Avg Score | **42.8/100** |
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **79.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **51.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **43.3/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **40.9/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **32.9/100** | **趋势 Trend**: → stable
