...
> **报告日期**: 2026-03-23
> **生成时间**: 2026-03-23T01:12:51.054926+00:00
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **72.1/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **54.3/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **50.9/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **50.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **41.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.4/100** | **趋势 Trend**: → stable
