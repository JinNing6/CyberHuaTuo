...
> **报告日期**: 2026-07-25
> **生成时间**: 2026-07-25T01:28:43.788399+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,837** |
| 📥 本周新增 New (7d) | **135** |
| ✅ 本周关闭 Closed (7d) | **121** |
| 💚 平均健康分 Avg Score | **51.5/100** |
...
- [pydantic-ai] ⚠️ 本周新增 56 个 Issues，高于常规水平
...
**框架**: `mcp` | **健康分数 Health Score**: **68.9/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **66.3/100** | **趋势 Trend**: → stable
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **63.8/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **42.7/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **37.7/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **35.3/100** | **趋势 Trend**: ↑ improving
