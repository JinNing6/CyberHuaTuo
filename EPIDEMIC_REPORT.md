...
> **报告日期**: 2026-06-17
> **生成时间**: 2026-06-17T02:36:55.427619+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,702** |
| 📥 本周新增 New (7d) | **144** |
| ✅ 本周关闭 Closed (7d) | **177** |
| 💚 平均健康分 Avg Score | **51.8/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 21，仅关闭 3
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **74.2/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **64.3/100** | **趋势 Trend**: → stable
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **61.3/100** | **趋势 Trend**: ↓ declining
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.1/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **31.0/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **29.7/100** | **趋势 Trend**: ↓ declining
