...
> **报告日期**: 2026-08-05
> **生成时间**: 2026-08-05T01:25:39.067220+00:00
...
- [pydantic-ai] ⚠️ 本周新增 107 个 Issues，高于常规水平
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **64.1/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langchain` | **健康分数 Health Score**: **51.0/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **47.8/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **44.5/100** | **趋势 Trend**: ↓ declining
...
- [Conversational Flow golden use case improvements - @persist silently drops assis](https://github.com/crewAIInc/crewAI/issues/6766) (👍 0)
- [Conversational Flow golden use case improvements - Anthropic total_tokens omits ](https://github.com/crewAIInc/crewAI/issues/6768) (👍 0)

---

### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **36.2/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **30.0/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **29.6/100** | **趋势 Trend**: ↑ improving
