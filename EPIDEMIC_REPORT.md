...
> **报告日期**: 2026-04-28
> **生成时间**: 2026-04-28T01:50:36.880817+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 13，仅关闭 0
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **70.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **62.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **58.8/100** | **趋势 Trend**: → stable
...
- [Google support both function tools and built-in tools](https://github.com/pydantic/pydantic-ai/issues/4788) (👍 5)

---

### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **55.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **51.6/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **47.9/100** | **趋势 Trend**: ↑ improving
...
- [[BUG] Native tool calls are discarded if LLM returns a text response](https://github.com/crewAIInc/crewAI/issues/4788) (👍 0)

---

### 🟠 langchain-ai/langchain
**框架**: `langchain` | **健康分数 Health Score**: **43.8/100** | **趋势 Trend**: → stable
...
- [Bug bounty](https://github.com/langchain-ai/langchain/issues/36952) (👍 10)

---

### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **38.5/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.1/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 8 / 💬 10)
