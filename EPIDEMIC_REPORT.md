...
> **报告日期**: 2026-06-02
> **生成时间**: 2026-06-02T02:33:25.077009+00:00
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **66.5/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **52.0/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **50.9/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **39.5/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **32.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **26.6/100** | **趋势 Trend**: ↑ improving
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 8 / 💬 12)
