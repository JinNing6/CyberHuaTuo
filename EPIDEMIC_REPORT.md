...
> **报告日期**: 2026-07-20
> **生成时间**: 2026-07-20T01:52:14.930362+00:00
...
- [mcp] ⚠️ 关闭率偏低：本周新增 12，仅关闭 0
- [mcp] 🔴 存在 5 个高影响 Bug Issues
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 15，仅关闭 0
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **71.4/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **66.2/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **63.0/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **41.5/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.1/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **34.4/100** | **趋势 Trend**: ↓ declining
...
**框架**: `llamaindex` | **健康分数 Health Score**: **31.5/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **23.6/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 9 / 💬 33)
