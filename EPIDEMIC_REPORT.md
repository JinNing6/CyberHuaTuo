...
> **报告日期**: 2026-06-25
> **生成时间**: 2026-06-25T02:07:10.195655+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,771** |
| 📥 本周新增 New (7d) | **97** |
| ✅ 本周关闭 Closed (7d) | **62** |
| 💚 平均健康分 Avg Score | **45.0/100** |
...
**框架**: `mcp` | **健康分数 Health Score**: **65.1/100** | **趋势 Trend**: ↑ improving
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **58.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **43.8/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **35.4/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **35.3/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **22.9/100** | **趋势 Trend**: ↑ improving
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 8 / 💬 16)
