...
> **报告日期**: 2026-08-15
> **生成时间**: 2026-08-15T00:34:45.863485+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,894** |
| 📥 本周新增 New (7d) | **165** |
| ✅ 本周关闭 Closed (7d) | **205** |
| 💚 平均健康分 Avg Score | **48.8/100** |
...
- [pydantic-ai] ⚠️ 本周新增 62 个 Issues，高于常规水平
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **64.6/100** | **趋势 Trend**: → stable
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **63.9/100** | **趋势 Trend**: ↓ declining
...
**框架**: `mcp` | **健康分数 Health Score**: **62.6/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **58.9/100** | **趋势 Trend**: → stable
