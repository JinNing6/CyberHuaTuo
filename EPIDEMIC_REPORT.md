...
> **报告日期**: 2026-05-21
> **生成时间**: 2026-05-21T02:05:19.714378+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,670** |
| 📥 本周新增 New (7d) | **125** |
| ✅ 本周关闭 Closed (7d) | **78** |
| 💚 平均健康分 Avg Score | **45.1/100** |
...
- [openai-sdk] ⚠️ 关闭率偏低：本周新增 16，仅关闭 1
...
**框架**: `mcp` | **健康分数 Health Score**: **69.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **49.8/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **32.9/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.8/100** | **趋势 Trend**: → stable
