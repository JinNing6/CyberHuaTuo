...
> **报告日期**: 2026-09-14
> **生成时间**: 2026-09-14T02:08:56.876098+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **3,184** |
| 📥 本周新增 New (7d) | **235** |
| ✅ 本周关闭 Closed (7d) | **161** |
| 💚 平均健康分 Avg Score | **47.8/100** |
...
- [mcp] 🐛 Bug 类 Issue 占比达 40%
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 25，仅关闭 1
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **61.2/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **57.3/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **53.8/100** | **趋势 Trend**: ↓ declining
...
- [[BUG] Python version discrepancy](https://github.com/crewAIInc/crewAI/issues/6662) (👍 0)
...
**框架**: `mcp` | **健康分数 Health Score**: **29.8/100** | **趋势 Trend**: → stable
