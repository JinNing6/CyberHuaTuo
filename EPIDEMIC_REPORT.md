...
> **报告日期**: 2026-05-01
> **生成时间**: 2026-05-01T01:54:39.548449+00:00
...
### 🟡 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **69.0/100** | **趋势 Trend**: ↑ improving
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **64.7/100** | **趋势 Trend**: ↑ improving
...
- [[BUG] Wrong code in document](https://github.com/crewAIInc/crewAI/issues/5378) (👍 0)
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.5/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **42.2/100** | **趋势 Trend**: ↑ improving
...
**框架**: `mcp` | **健康分数 Health Score**: **27.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **22.9/100** | **趋势 Trend**: → stable
