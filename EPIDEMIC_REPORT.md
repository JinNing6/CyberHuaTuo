...
> **报告日期**: 2026-07-19
> **生成时间**: 2026-07-19T01:26:49.926585+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 12，仅关闭 0
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **67.6/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **66.9/100** | **趋势 Trend**: → stable
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.9/100** | **趋势 Trend**: ↓ declining
...
**框架**: `mcp` | **健康分数 Health Score**: **34.2/100** | **趋势 Trend**: ↓ declining
