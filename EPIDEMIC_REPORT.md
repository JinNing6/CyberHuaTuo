...
> **报告日期**: 2026-07-18
> **生成时间**: 2026-07-18T01:20:15.045485+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,812** |
| 📥 本周新增 New (7d) | **153** |
| ✅ 本周关闭 Closed (7d) | **99** |
| 💚 平均健康分 Avg Score | **46.5/100** |
...
### 🟡 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **70.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **34.1/100** | **趋势 Trend**: ↓ declining
