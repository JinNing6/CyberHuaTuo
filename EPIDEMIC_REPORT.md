...
> **报告日期**: 2026-09-25
> **生成时间**: 2026-09-25T02:17:48.558204+00:00
...
- [langchain] ⚠️ 本周新增 67 个 Issues，高于常规水平
- [langchain] 🔴 存在 5 个高影响 Bug Issues
- [langchain] 🐛 Bug 类 Issue 占比达 64%
- [crewai] ⚠️ 本周新增 58 个 Issues，高于常规水平
- [crewai] ⚠️ 关闭率偏低：本周新增 58，仅关闭 17
- [crewai] 🔴 存在 5 个高影响 Bug Issues
- [llamaindex] ⚠️ 关闭率偏低：本周新增 19，仅关闭 4
...
- [pydantic-ai] ⚠️ 本周新增 88 个 Issues，高于常规水平
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 25，仅关闭 4
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **74.4/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **59.4/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **54.1/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **41.9/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **38.4/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **34.3/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **33.8/100** | **趋势 Trend**: ↓ declining
