...
> **报告日期**: 2026-08-18
> **生成时间**: 2026-08-18T00:34:20.352516+00:00
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 14，仅关闭 0
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **60.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **59.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **55.3/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **54.5/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **38.6/100** | **趋势 Trend**: ↑ improving
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **38.4/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **24.3/100** | **趋势 Trend**: → stable
...
- [Run Cancellation Causes Loss of Streamed State Not Yet Persisted as a Checkpoint](https://github.com/langchain-ai/langgraph/issues/5672) (👍 9 / 💬 39)
