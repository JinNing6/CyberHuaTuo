...
> **报告日期**: 2026-05-19
> **生成时间**: 2026-05-19T02:07:28.678828+00:00
...
- [openai-sdk] ⚠️ 关闭率偏低：本周新增 11，仅关闭 1
...
**框架**: `mcp` | **健康分数 Health Score**: **58.4/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **46.1/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **42.7/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **34.5/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **23.4/100** | **趋势 Trend**: ↓ declining
...
**框架**: `langgraph` | **健康分数 Health Score**: **21.5/100** | **趋势 Trend**: → stable
