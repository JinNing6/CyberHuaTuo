...
> **报告日期**: 2026-07-27
> **生成时间**: 2026-07-27T01:50:00.149079+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,845** |
| 📥 本周新增 New (7d) | **116** |
| ✅ 本周关闭 Closed (7d) | **112** |
| 💚 平均健康分 Avg Score | **51.7/100** |
...
- [langgraph] ⚠️ 关闭率偏低：本周新增 16，仅关闭 4
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **67.8/100** | **趋势 Trend**: → stable
...
### 🟠 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **58.0/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **57.7/100** | **趋势 Trend**: ↑ improving
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **51.9/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **40.7/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **37.6/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **27.6/100** | **趋势 Trend**: → stable
