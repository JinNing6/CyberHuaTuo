...
> **报告日期**: 2026-09-10
> **生成时间**: 2026-09-10T01:54:01.087426+00:00
...
- [langchain] ⚠️ 本周新增 72 个 Issues，高于常规水平
...
- [pydantic-ai] ⚠️ 本周新增 63 个 Issues，高于常规水平
- [pydantic-ai] 🔴 存在 5 个高影响 Bug Issues
- [langgraph] ⚠️ 关闭率偏低：本周新增 28，仅关闭 0
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **62.0/100** | **趋势 Trend**: → stable
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **57.5/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **54.6/100** | **趋势 Trend**: ↓ declining
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **48.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langchain` | **健康分数 Health Score**: **45.4/100** | **趋势 Trend**: → stable
...
**框架**: `llamaindex` | **健康分数 Health Score**: **32.3/100** | **趋势 Trend**: ↑ improving
...
**框架**: `langgraph` | **健康分数 Health Score**: **31.1/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **30.2/100** | **趋势 Trend**: → stable
