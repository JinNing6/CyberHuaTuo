...
> **报告日期**: 2026-03-30
> **生成时间**: 2026-03-30T01:19:49.055923+00:00
...
### 🟡 deepset-ai/haystack
**框架**: `haystack` | **健康分数 Health Score**: **70.6/100** | **趋势 Trend**: ↓ declining
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **62.6/100** | **趋势 Trend**: ↑ improving
...
**🔥 热门 Issues / Hot Issues**:
- [support batch processing](https://github.com/pydantic/pydantic-ai/issues/1771) (👍 26 / 💬 2)
...
**框架**: `mcp` | **健康分数 Health Score**: **61.8/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **41.7/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **41.4/100** | **趋势 Trend**: → stable
...
### 🔴 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **38.6/100** | **趋势 Trend**: → stable
...
### 🔴 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **34.9/100** | **趋势 Trend**: → stable
...
- [[BUG] CrewAgentExecutor does not reset messages and iterations between task exec](https://github.com/crewAIInc/crewAI/issues/4389) (👍 0)
