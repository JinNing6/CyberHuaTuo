...
> **报告日期**: 2026-03-31
> **生成时间**: 2026-03-31T01:17:29.453940+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,548** |
| 📥 本周新增 New (7d) | **173** |
| ✅ 本周关闭 Closed (7d) | **104** |
| 💚 平均健康分 Avg Score | **44.0/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **62.1/100** | **趋势 Trend**: ↑ improving
...
### 🟠 microsoft/autogen
**框架**: `autogen` | **健康分数 Health Score**: **58.5/100** | **趋势 Trend**: → stable
...
### 🟠 stanfordnlp/dspy
**框架**: `dspy` | **健康分数 Health Score**: **42.6/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **36.9/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **26.9/100** | **趋势 Trend**: → stable
