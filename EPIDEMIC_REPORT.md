...
> **报告日期**: 2026-07-06
> **生成时间**: 2026-07-06T02:01:42.562810+00:00
...
|:---|:---|
| 📈 监控框架数 Frameworks | **10** |
| 🔓 总开放 Issues Total Open | **2,752** |
| 📥 本周新增 New (7d) | **133** |
| ✅ 本周关闭 Closed (7d) | **164** |
| 💚 平均健康分 Avg Score | **50.8/100** |
...
**框架**: `pydantic-ai` | **健康分数 Health Score**: **82.0/100** | **趋势 Trend**: → stable
...
**框架**: `mcp` | **健康分数 Health Score**: **63.5/100** | **趋势 Trend**: ↑ improving
...
**框架**: `llamaindex` | **健康分数 Health Score**: **50.1/100** | **趋势 Trend**: → stable
...
### 🟠 crewAIInc/crewAI
**框架**: `crewai` | **健康分数 Health Score**: **49.6/100** | **趋势 Trend**: → stable
...
**框架**: `langchain` | **健康分数 Health Score**: **42.4/100** | **趋势 Trend**: → stable
...
**框架**: `langgraph` | **健康分数 Health Score**: **28.5/100** | **趋势 Trend**: → stable
...
**框架**: `openai-sdk` | **健康分数 Health Score**: **22.0/100** | **趋势 Trend**: ↓ declining
